...
$resapp = mysqli_query($con, "SELECT * FROM appointment where adate ='$datad' AND docid='$_POST[name]'");
?>
...
<div id="container">
    <div class="wrapper">
        <div id="content">
                ...
                <table width="465" border="1">
                    <tr>
                        <td width="155"><strong>Name :
                                <?php
                                $resdcapp = mysqli_query("SELECT * FROM doctor");
                                ?>
                                <select name="name" id="name">
                                    <?php
                                    while ($row26z = mysqli_fetch_array($resdcapp)) {
                        ...
                        <td width="201">
                            ...
                            <img src="images2/cal.gif" alt="" width="21" height="22" style="cursor:pointer"
                ...
                while ($row1 = mysqli_fetch_array($resapp)) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $row1["patid"];
                            $respac = mysqli_query($con, "SELECT * FROM patient where patid='$row1[patid]'");
                        ...
                        <td><?php echo $row1["docid"];
                            $respacdoc = mysqli_query($con, "SELECT * FROM doctor where docid='$row1[docid]'");
                        ...
                        <td width="43"><a href="empappview.php?adate=<?php echo $row1[appointid]; ?>"><img
                                    src="images/icons/remove.png" alt="" width="32" height="32"/></a><a
                                href="empappview.php?adate=<?php echo $row1[appointid]; ?>"></a></td>
                    </tr>
                    <?php
                }
                ?>
            ...
            <p><br/>
                <a href="adminaccount.php"> < < Back </a></p>
