...
{
$sql = mysql_query("SELECT * FROM employee WHERE empid = '$_POST[loginid1]' AND password='$_POST[password]'");
$count =  mysql_num_rows($sql);
	if($count == 1)
	{
	$resrec= mysql_query("UPDATE pemployee SET password='$_POST[newpass]' WHERE empid = '$_POST[loginid1]' ");
